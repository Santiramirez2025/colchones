...
export const SEO_DEFAULTS = {
  title: 'Colchones Premium | TiendaColchon',
  description: 'Descubre colchones premium con tecnología muelles ensacados. Certificados de calidad europea, envío gratis y 3 años de garantía.',
